...
const VERTICALS = {
  CA: {
    ...
    programs: [
      ...
      { id: 'PF', name: 'Prof. Foundations', courses: ['PF-1: Self-Leadership & Learning Foundations', 'PF-2: Data Literacy, Research, & Problem Framing', 'PF-3: Communication & Professional Writing', 'PF-4: Teamwork & Agile Workflows', 'PF-5: Career Exploration & Professional Identity'] }
    ]
  },
  CREATIVE: {
    name: 'CREATIVE TECH',
  ...
  TECHLITE: {
    ...
    programs: [
      { id: 'DA', name: 'Data Analytics', courses: ['DA-1: Data and AI Literacy Foundations', 'DA-2: Data Analytics with Spreadsheets', 'DA-3: SQL for Data', 'DA-4: PowerBI for Data Analytics'] },
