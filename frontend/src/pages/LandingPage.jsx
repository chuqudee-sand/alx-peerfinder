...
const VERTICALS = {
  CA: {
    ...
    programs: [
      { id: 'VA', name: 'Virtual Assistant', icon: '💻', courses: ['VA-1: VA Foundations & Professional Identity', 'VA-2: Core Professional & Soft Skills for VAs', 'VA-3: VA Tech Tools & Digital Productivity', 'VA-4: Essential VA Task Execution', 'VA-5: VA Career Readiness, Freelancing & Client Work', 'VA-6: VA Specialisation, Toolkit & Next Steps'] },
      ...
      { id: 'PF', name: 'Prof. Foundations', icon: '👔', courses: ['PF-1: Professional Foundations Onboarding', 'PF-2: Self-Leadership & Learning Foundations', 'PF-3: Data Literacy, Research, & Problem Framing', 'PF-4: Communication & Professional Writing', 'PF-5: Teamwork & Agile Workflows', 'PF-6: Human-Centered Design & Prototyping', 'PF-7: Career Exploration & Professional Identity'] }
    ]
  },
  CREATIVE: {
    name: 'CREATIVE TECH',
